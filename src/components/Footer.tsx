      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
        <div className="md:col-span-2">
          ...
          <p className="text-primary-foreground/70 text-sm max-w-md leading-relaxed">
            Regenerating the Congo Basin through data intelligence. An AI-powered environmental platform democratizing access to climate and agricultural data across Africa.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="flex flex-col gap-2">
            {["Open Data", "AI Assistant", "Data Explorer", "About"].map((item) => (
