...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "home.loading_data": { en: "Loading climate data...", fr: "Chargement des données climatiques..." },
  "home.source_nasa": { en: "Source: NASA POWER", fr: "Source : NASA POWER" },
  "home.data_source": { en: "Data provided by NASA POWER API — updated daily", fr: "Données fournies par l'API NASA POWER — mises à jour quotidiennement" },
  "home.rainy": { en: "Rainy", fr: "Pluvieux" },
  "home.cloudy": { en: "Cloudy", fr: "Nuageux" },
  "home.precip_today": { en: "Precip. today", fr: "Précip. du jour" },
  "home.solar": { en: "Solar Rad.", fr: "Rayonnement" },
  "home.precip_30d": { en: "Precipitation (30d)", fr: "Précipitations (30j)" },
  "home.avg_temp_30d": { en: "Avg. Temp (30d)", fr: "Temp. Moy. (30j)" },
  "home.agri_good": { en: "Favorable growing conditions", fr: "Conditions de croissance favorables" },
  "home.agri_moderate": { en: "Moderate growing conditions", fr: "Conditions de croissance modérées" },
  "home.last_7_days": { en: "Last 7 Days", fr: "7 Derniers Jours" },
  "home.temperature": { en: "Temperature", fr: "Température" },
  "home.precipitation": { en: "Precipitation", fr: "Précipitations" },
  "home.temp_range": { en: "Temp. Range (30d)", fr: "Plage Temp. (30j)" },
  "home.last_30_days": { en: "Over last 30 days", fr: "Sur les 30 derniers jours" },
  "home.avg_humidity_label": { en: "Avg. Humidity", fr: "Humidité Moyenne" },
  "home.humidity_status": { en: "Tropical", fr: "Tropicale" },

  // Agricultural insights
  "agri.insights_title": { en: "Agricultural Intelligence", fr: "Intelligence Agricole" },
  "agri.planting_window": { en: "Planting Window", fr: "Fenêtre de Semis" },
  "agri.planting_favorable": { en: "Conditions are favorable for planting cassava, beans, and maize. Soil moisture and temperatures are adequate.", fr: "Les conditions sont favorables pour le semis de manioc, haricots et maïs. L'humidité du sol et les températures sont adéquates." },
  "agri.planting_wait": { en: "Wait for more precipitation before planting. Current moisture levels may be insufficient.", fr: "Attendez plus de précipitations avant de semer. Les niveaux d'humidité actuels peuvent être insuffisants." },
  "agri.irrigation": { en: "Irrigation Need", fr: "Besoin d'Irrigation" },
  "agri.irrigation_sufficient": { en: "Natural rainfall is sufficient. No additional irrigation needed for most crops.", fr: "Les précipitations naturelles sont suffisantes. Pas d'irrigation supplémentaire nécessaire." },
  "agri.irrigation_needed": { en: "Consider supplemental irrigation, especially for vegetable crops and nurseries.", fr: "Envisagez une irrigation d'appoint, surtout pour les cultures maraîchères et pépinières." },
  "agri.pest_risk": { en: "Pest Risk", fr: "Risque Parasitaire" },
  "agri.pest_high": { en: "High humidity increases risk of fungal diseases. Monitor cassava mosaic and bean rust.", fr: "L'humidité élevée augmente le risque de maladies fongiques. Surveillez la mosaïque du manioc et la rouille du haricot." },
  "agri.pest_low": { en: "Low to moderate pest risk. Maintain regular crop monitoring.", fr: "Risque parasitaire faible à modéré. Maintenez une surveillance régulière des cultures." },
  "agri.crop_rec": { en: "Crop Recommendation", fr: "Culture Recommandée" },
  "agri.crop_rec_warm": { en: "Ideal for: cassava, sweet potato, maize, beans, sorghum. Consider banana plantations.", fr: "Idéal pour : manioc, patate douce, maïs, haricots, sorgho. Envisagez les plantations de bananiers." },
  "agri.crop_rec_cool": { en: "Ideal for: potatoes, wheat, peas, cabbage. Higher altitude crops thrive.", fr: "Idéal pour : pommes de terre, blé, pois, chou. Les cultures d'altitude prospèrent." },
  "agri.soil_tip": { en: "Soil Health", fr: "Santé du Sol" },
  "agri.soil_erosion_risk": { en: "Heavy rains increase erosion risk. Use mulching, terracing, and cover crops to protect topsoil.", fr: "Les fortes pluies augmentent le risque d'érosion. Utilisez le paillage, le terrassement et les cultures de couverture." },
  "agri.soil_stable": { en: "Soil conditions are stable. Good time for composting and organic amendments.", fr: "Les conditions du sol sont stables. Bon moment pour le compostage et les amendements organiques." },
  "agri.season": { en: "Growing Season", fr: "Saison Culturale" },
  "agri.season_info": { en: "Season B (Feb-Jun) in progress. Plan harvest schedules and post-harvest storage.", fr: "Saison B (fév-juin) en cours. Planifiez les calendriers de récolte et le stockage post-récolte." },

  // Media
  "media.create": { en: "Write Article", fr: "Écrire un Article" },
  "media.login_to_create": { en: "Sign in to write", fr: "Connectez-vous pour écrire" },
